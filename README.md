...
ยังไม่รวม Realtime, Notification, Chat, การเชื่อมรูปอัลบั้มกับปฏิทิน, drag-and-drop board และหน้ากู้คืนบอร์ดที่จัดเก็บไว้
...
- ธีม 3 แบบต่อประเภทห้อง: TogetherSpace, Warm Light และธีมเฉพาะประเภท โดยเปลี่ยนทั้งเว็บไซต์และเก็บค่าไว้เฉพาะเครื่อง

## แผนโมดูลถัดไป

1. ทดสอบ Finance แบบหลายสมาชิกหลังรัน migration `0014` และเก็บ UX ของฟอร์มแก้ไข/ลบข้อมูลเฉพาะประเภท
2. ออกแบบ Board ของเพื่อน คู่รัก และครอบครัวให้ต่างกันก่อนแก้ schema
3. ห้องครอบครัว: ผังครอบครัวที่เริ่มจากสมาชิกในห้อง
4. ห้องเพื่อน: โปรไฟล์แนะนำตัวแบบละเอียด โดยกำหนดฟิลด์ก่อนเริ่มพัฒนา
5. ตรวจ responsive, accessibility และ flow ข้ามโมดูลก่อนเพิ่ม Realtime/Notification
