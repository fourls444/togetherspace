...
หากใช้ SQL Editor ของ Supabase ให้รัน migration ตามลำดับจนถึง
`drizzle/0014_room_type_finance.sql` เพื่อเปิดใช้โมดูลการเงินแบบแยกตามประเภทห้อง ตารางแบ่งค่าใช้จ่าย และ RLS
...
- Row Level Security
- Chat แบบ Realtime ภายในห้อง
- ผังครอบครัวสำหรับห้องประเภทครอบครัว
- โปรไฟล์เพื่อนแบบละเอียดสำหรับห้องประเภทเพื่อน
- ธีมเว็บไซต์และธีมเฉพาะประเภทห้องที่จำค่าในเครื่อง
- Board drag-and-drop, จัดเก็บ และกู้คืนรายการ

ยังไม่รวม Notification และการเชื่อมรูปอัลบั้มกับปฏิทิน
...
- ห้อง สมาชิก คำเชิญ และโปรไฟล์ประจำห้อง
- บอร์ด โน้ต เช็กลิสต์ และโพล
- ปฏิทินรายเดือน/รายปี พร้อมวันสำคัญและกิจกรรม
- อัลบั้มหลายรูป พร้อมลากจัดลำดับ
- แผนที่และรายการสถานที่
- การเงินแกนกลาง: เพิ่ม/แก้ไข/ลบค่าใช้จ่าย เลือกหมวด แบ่งเท่ากันหรือกำหนดเอง และสรุปยอดคืน
- กลุ่มเพื่อน: ทริป กองกลาง เงินสมทบ และบันทึกการคืนเงินจริง
- คู่รัก: กองเดต หมวดค่าใช้จ่าย และภาพรวมการใช้เงินร่วมกัน
- ครอบครัว: รายรับรายสมาชิก งบประมาณรายเดือน และค่าใช้จ่ายรายหมวด
- ธีม 4 แบบต่อประเภทห้อง: TogetherSpace, Warm Light และธีมมืด/สว่างเฉพาะประเภท โดยเปลี่ยนทั้งเว็บไซต์และเก็บค่าไว้เฉพาะเครื่อง

## แผนงานปัจจุบัน

ระบบหลักและโมดูลหลักพร้อมใช้งานแล้ว งานที่เหลือเป็น UX/UI Quality Pass:

1. ตรวจ responsive ที่ 360, 768, 1024 และ 1440px ทุกหน้าหลัก
2. ตรวจ keyboard navigation, focus state, modal, tooltip และ screen reader label
3. ตรวจ empty, loading, error และ success state ให้สำนวนและ layout สอดคล้องกัน
4. ตรวจความสม่ำเสมอของหัวข้อ ไอคอน ปุ่ม สี และระยะห่างระหว่างโมดูล
5. ตรวจ flow ข้ามหน้าและสิทธิ์ Owner/Member ด้วยบัญชี Supabase จริง

หลัง Quality Pass จึงค่อยพิจารณา Notification และการเชื่อมรูปอัลบั้มกับปฏิทิน
