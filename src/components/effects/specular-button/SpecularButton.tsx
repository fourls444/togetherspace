...
export type SpecularButtonProps = {
  ...
  className?: string;
  /** เมื่อมี href จะเรนเดอร์เป็นลิงก์ (Next Link) แทนปุ่ม */
  href?: string;
  prefetch?: boolean;
};

/** Specular glass button จาก React Bits — ขอบแสงตามเคอร์เซอร์ */
export default function SpecularButton({
  ...
  const propsRef = useRef<SpecularLiveProps>({
    radius,
    lineColor,
    baseColor,
    intensity,
  ...
  const classNames = `specular-button specular-button--${size}${
    className ? ` ${className}` : ""
  }`;
  const style = {
    "--sb-radius": `${radius}px`,
