...
export type BorderGlowProps = {
  children: ReactNode;
  className?: string;
  /** คลาสของชั้นเนื้อหาด้านใน (layout/padding ของการ์ด) */
...
/** BorderGlow จาก React Bits — ขอบเรืองตามเคอร์เซอร์ */
export default function BorderGlow({
  ...
  return (
    ...
    >
      ...
      <div
        className={`border-glow-inner${contentClassName ? ` ${contentClassName}` : ""}`}
      >
        {children}
      </div>
    </div>
